...
class CourseInfo(models.Model):
    ...
    level = models.CharField(choices=(('gj','高级'),('zj','中级'),('cj','初级')),max_length=10,verbose_name="课程难度")
    ...
    course_notice = models.CharField(max_length=100,verbose_name="课程公共")
    course_need = models.CharField(max_length=100,verbose_name="课程须知")
    teacher_tell = models.CharField(max_length=100,verbose_name="教师指导")
