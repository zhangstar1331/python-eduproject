...
class TeacherInfo(models.Model):
    ...
    work_company = models.ForeignKey(OrgInfo,on_delete=models.CASCADE,verbose_name="所属机构")
    age = models.IntegerField(default=30,verbose_name="讲师年龄")
    gender = models.CharField(choices=(('boy','男'),('gril','女')),max_length=10,verbose_name="讲师性别")
    love_num = models.IntegerField(default=0,verbose_name="收藏数")
    click_num = models.IntegerField(default=0,verbose_name="访问量")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
